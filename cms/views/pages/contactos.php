<?php
$contactos = ControllerContacto::ctrMostrarContactos();
?>
            ...
            <div class="min-height-200px">
                ...
                <div class="card-box mb-30">
                    <div class="card">
                        <div class="card-body">
                            <div class="pd-20">
                                <h4 class="text-blue h4">Lista de contactos</h4>
                            </div>
                            <div class="pb-20">
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                                            <button class="dropdown-item"  onclick="borrarContacto(<?php echo $value["id"] ?>)"><i class="dw dw-delete-3"></i>Borrar</button>
